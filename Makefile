...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /scratch/user/roeebelkin/14-peas-in-a-pod/CMakeFiles /scratch/user/roeebelkin/14-peas-in-a-pod/CMakeFiles/progress.marks
	$(MAKE) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /scratch/user/roeebelkin/14-peas-in-a-pod/CMakeFiles 0
.PHONY : all
